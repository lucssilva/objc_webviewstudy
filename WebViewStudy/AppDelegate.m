...
//  WebViewStudy
//
//  Created by Lucas Silva on 20/08/21.
//
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    WKWebView *webView = [[WKWebView alloc] initWithFrame:CGRectMake(0, 20, UIScreen.mainScreen.bounds.size.width,UIScreen.mainScreen.bounds.size.height - 20) configuration:webConfiguration];
